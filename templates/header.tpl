...
<head>
	...
	<link rel="stylesheet" type="text/css" href="/plugins/nodebb-theme-chinese-fi/css/needsharebutton.css" />
	...
	<script src="/plugins/nodebb-theme-chinese-fi/lib/needsharebutton.js"></script>
